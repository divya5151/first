...
<body>
  ...
  {
	  %>
	  <center><font color="red" size="5">Form submitted successfully you will get notified within 48 hours</font></center>
	  <% 
  }
 ...
 <input type="mail" name="email" placeholder="Enter email Address" required="required">
